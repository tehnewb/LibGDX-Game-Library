 ...
 */
public class ConfigSection implements Map<Object, Object> {
	 ...
	 */
	public ConfigSection(Map<Object, Object> values) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public ConfigSection set(Object s, Object obj) {
		...
		if (obj instanceof ConfigSection) obj = ((ConfigSection) obj).map;
	...
	public ConfigSection getUnderlyingSection(String key) {
		ConfigSection c = getUnderlyingSection(key, null);
